...
>Note: YAML files used in this tutorial are stored in [/docs/examples/platforms/minio](/docs/examples/platforms/minio) directory of [appscode/stash](https://github.com/appscode/stash) repository.
