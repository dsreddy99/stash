...
- At first, you need to have some backup taken by Stash. If you already don't have any backup repository, create one by following this [backup tutorial](/docs/guides/old/backup.md).
...
>Note: If you are using [Local](/docs/guides/old/backends/local.md) backend for storing backup snapshots, your workload must be running to be able to list snapshots.
